...
class KeyCtrl
    ...
    constructor: (@editor) ->
        @info = null
        @editor.view.addEventListener 'keydown',  @keyDownHandler, true
        @editor.view.addEventListener 'keyup',    @keyUpHandler,   true
    ...
    keyDownHandler: (event) =>
        ...
        if info.isChar
            ...
            if type
                ...
                console.log 'no type found: ', info
        else
            console.log 'nothing found: ', info
        @
