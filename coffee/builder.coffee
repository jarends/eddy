...
class Builder
    ...
    printHelp: () ->
        console.log """usage:
run          (r)   - run app from app folder
open         (o)   - open app from build folder
install      (i)   - install and launch app
launch       (l)   - launch app
mac          (m)   - build for mac
...
create-icons (ci)  - create app icons
distribute   (d)   - create icons, build for mac and install the app"""
        null
